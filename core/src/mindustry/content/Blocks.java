...
public class Blocks{
    ...
    repairPoint, repairTurret, resupplyPoint, droneCenter,
    ...
    //campaign
    launchPad, launchPadLarge, coreSilo, interplanetaryAccelerator,
    ...
    public static void load(){
        ...
        largeCliffCrusher = new WallCrafter("large-cliff-crusher"){{
            ...
            consumeItem(Items.graphite).boost();
            itemCapacity = 20;
        ...
        horde = new ItemTurret("horde"){{
            ...
            Items.surgeAlloy, new MissileBulletType(4.2f, 18) {{
                velocityRnd = 0.2f;
                shootEffect = Fx.colorSpark;
                smokeEffect = Fx.shootBigSmoke;
                hitColor = backColor = trailColor = Pal.engine;
                frontColor = Pal.yellowBoltFront;
                trailWidth = 2f;
                trailLength = 12;
        ...
        afflict = new PowerTurret("afflict"){{
            ...
            //buildCostMultiplier = 1f; this is redundant
        ...
        ravage = new PayloadAmmoTurret("ravage") {{
            ...
            ammo(
            //this is really lazy
            reinforcedSurgeWall, new ArtilleryBulletType(10f, 400) {{
                sprite = "reinforced-surge-wall";
                height = width = hitSize = 8f;
                ...
                berylliumWall, new ArtilleryBulletType(7.5f, 400) {{
                    sprite = "beryllium-wall";
                    height = width = hitSize = 8f;
