...
public class TantrosPlanetGenerator extends PlanetGenerator{
    ...
    BaseGenerator basegen = new BaseGenerator(); //this makes zero sense but it's staying for now

    Block[][] arr =
    {
    {Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.stone, Blocks.stone},
    {Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.stone, Blocks.stone, Blocks.stone},
    {Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.bluemat, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.stone, Blocks.stone, Blocks.stone},
    {Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.darksand, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.bluemat, Blocks.redmat, Blocks.basalt},
    {Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.bluemat, Blocks.darksand, Blocks.darksand, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt},
    {Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.redmat, Blocks.redmat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.bluemat, Blocks.basalt},
    {Blocks.bluemat, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.redmat, Blocks.redmat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.bluemat, Blocks.basalt},
    {Blocks.bluemat, Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.bluemat, Blocks.redmat, Blocks.bluemat, Blocks.redmat, Blocks.bluemat, Blocks.basalt, Blocks.bluemat, Blocks.basalt, Blocks.basalt},
    {Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.redmat, Blocks.redmat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.bluemat, Blocks.basalt, Blocks.basalt},
    {Blocks.basalt, Blocks.darksand, Blocks.darksand, Blocks.redmat, Blocks.basalt, Blocks.basalt, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.bluemat, Blocks.basalt, Blocks.darksand, Blocks.redmat, Blocks.redmat, Blocks.basalt, Blocks.basalt, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.redmat, Blocks.basalt, Blocks.darksand, Blocks.redmat, Blocks.redmat, Blocks.redmat, Blocks.redmat, Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.basalt, Blocks.darksand, Blocks.bluemat, Blocks.basalt, Blocks.redmat, Blocks.bluemat, Blocks.bluemat, Blocks.bluemat, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt}
    };
    {
        baseSeed = 1;
    }
    ...
    protected void generate(){
        class Room{
            ...
            void connectLiquid(Room to){
                ...
                //add randomised offset to avoid straight lines
                midpoint.add(Tmp.v2.setToRandomDirection(rand).scl(Tmp.v1.dst(x, y)));
                midpoint.sub(width / 2f, height / 2f).limit(width / 2f / Mathf.sqrt3).add(width / 2f, height / 2f);
